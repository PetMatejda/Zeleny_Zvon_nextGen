...
export default function SuccessPage() {
  ...
  return (
    <main className="max-w-3xl mx-auto px-8 pt-20 pb-32 text-center font-plusjakarta">
      ...
      <div className="mt-12">
        <Link href="/eshop" className="px-8 py-4 bg-[#101f0d] dark:bg-[#faf9f4] text-[#faf9f4] dark:text-[#101f0d] rounded-full font-bold hover:bg-[#765a17] dark:hover:bg-[#ffdf9f] transition-colors inline-block">
          Zpět do E-shopu
        </Link>
      </div>
    </main>
